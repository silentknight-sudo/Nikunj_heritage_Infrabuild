  ...
  return (
    ...
    >
      <motion.div
        ...
        animate={{
          scale: prefersReducedMotion ? 1 : isHovered ? 1.02 : 1,
          boxShadow: isHovered 
            ? "0 25px 50px -12px rgba(11, 16, 48, 0.18), 0 0 40px rgba(232, 179, 61, 0.18)"
...
export const SacredPropertyBackdrop: React.FC = () => {
  return (
    ...
    >
      <div className="absolute inset-0 bg-[radial-gradient(circle_at_top,rgba(232,179,61,0.12),transparent_28%),linear-gradient(180deg,rgba(246,239,226,0.96),rgba(246,239,226,0.92))]" />
      <motion.div
        className="absolute -left-24 top-24 h-72 w-72 rounded-full blur-3xl"
        style={{ background: "rgba(232, 121, 46, 0.14)" }}
      ...
      <motion.div
        ...
        style={{ background: "rgba(232, 179, 61, 0.12)" }}
      ...
      <motion.div
        ...
        style={{
          backgroundImage:
            "linear-gradient(rgba(232,179,61,0.65) 1px, transparent 1px), linear-gradient(90deg, rgba(232,179,61,0.65) 1px, transparent 1px)",
      ...
      />
      <motion.div
        className="absolute bottom-20 left-0 right-0 h-px bg-gradient-to-r from-transparent via-[color:var(--brand-gold)]/40 to-transparent"
